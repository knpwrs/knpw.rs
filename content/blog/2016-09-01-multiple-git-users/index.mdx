...
Now whenever we change in to this directory, _or any directory underneath this
directory_, those environment variables will be set. Note that the first time
