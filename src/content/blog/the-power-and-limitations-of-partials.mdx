...
// The solution is to explicitly call mult2 with the arguments you want to pass
console.log(
...
// explicitly declare async test functions:
...
[post]: /blg/testing-in-browsers-and-node/ 'Testing in Browsers and Node with Mocha, Chai, Sinon, and Testem'
